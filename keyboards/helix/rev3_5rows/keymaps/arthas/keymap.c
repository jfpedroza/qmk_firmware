...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT(
      ...
      _______, XXXXXXX, KC_Z   , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
      ),
...
#define CHRMIUM SGUI(KC_F4)

  [_LAUNCH] =  LAYOUT(
      XXXXXXX, FIREFOX, THUNDER, TELEGRM, FERDIUM, SPOTIFY,                   FFDEVED, SLACK,   DBEAVER, CHRMIUM, XXXXXXX, XXXXXXX,
      XXXXXXX, FILEEXP, TODOIST, TASKMGR, AUTOBOT, VIMWIKI,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
#define KP_ENTER KC_KP_ENTER
  ...
  [_KEYPAD] =  LAYOUT_wrapper(
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_NUM,  XXXXXXX, KP_EQ____SLASH____ASTER,   KC_BSPC,
  ...
  [_ADJUST] =  LAYOUT(
      ...
      XXXXXXX, QK_BOOT, RGBRST,  EE_CLR,  XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
