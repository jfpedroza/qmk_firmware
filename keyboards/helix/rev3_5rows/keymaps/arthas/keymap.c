...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Esc  | GUI  | Alt  | XXXX |Lower |Space |Space |Raise | XXXX | RAlt | Menu | XXXX |RCtrl |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_ESC,  KC_LGUI, KC_LALT, KC_NO,   LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_NO,   KC_RALT, KC_APP,  KC_NO,   KC_RCTL \
    ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
